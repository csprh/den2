...
'/mnt/storage/scratch/csprh/ICME/PNGS/S2ElFuente-Cars_1920x1080_60fps_10bit_420',...
'/mnt/storage/scratch/csprh/ICME/PNGS/S3ElFuente-Cyclist_1920x1080_60fps_10bit_420',...
'/mnt/storage/scratch/csprh/ICME/PNGS/S4Chimera-Dinner_1920x1080_60fps_10bit_420',...
'/mnt/storage/scratch/csprh/ICME/PNGS/S5Campfire_1920x1080_30fps_10bit_420',...
'/mnt/storage/scratch/csprh/ICME/PNGS/S6SmokeClear_1920x1080_60fps_10bit_420'};


folderTestOut  = {'/mnt/storage/scratch/csprh/ICME/DENOISED1/S1ElFuente-Palacio_1920x1080_60fps_10bit_420',...
'/mnt/storage/scratch/csprh/ICME/DENOISED1/S2ElFuente-Cars_1920x1080_60fps_10bit_420',...
'/mnt/storage/scratch/csprh/ICME/DENOISED1/S3ElFuente-Cyclist_1920x1080_60fps_10bit_420',...
'/mnt/storage/scratch/csprh/ICME/DENOISED1/S4Chimera-Dinner_1920x1080_60fps_10bit_420',...
'/mnt/storage/scratch/csprh/ICME/DENOISED1/S5Campfire_1920x1080_30fps_10bit_420',...
'/mnt/storage/scratch/csprh/ICME/DENOISED1/S6SmokeClear_1920x1080_60fps_10bit_420'};
...
for ii = 1: 6
    innerLoop(net, folderTest{ii}, folderTestOut{ii})
end
...
for i = 1:length(filePaths)
    ...
    output(output>1) = 1;
    output(output<0) = 0;
    imwrite( uint16(round(output*65535)), fullfile(folderTestOut,filePaths(i).name));
