...
thisModel = fullfile(dataBase,['imdbFin_',num2str(theseClasses),'_',num2str(theseBands)]);
modelName = fullfile(modelBase,['modelFin_',num2str(theseClasses),'_',num2str(theseBands)]);
%%%-----------------------------------------------------------i--------------
%%% Configuration
%%%-------------------------------------------------------------------------
