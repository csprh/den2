...
function net = DnCNN_init_model_Huwei_All
...
net.layers{end+1} = struct('type', 'conv', ...
    'weights', {{sqrt(2/(27*64))*randn(3,3,3,64,'single'), zeros(64,1,'single')}}, ...
    'stride', 1, ...
    'pad', 1, ...
    'dilate',1, ...
    'learningRate',lr11, ...
...
net.layers{end+1} = struct('type', 'conv', ...
    'weights', {{sqrt(2/(27*64))*randn(3,3,64,3,'single'), zeros(1,3,'single')}}, ...
    'stride', 1, ...
    'learningRate',lr11, ...
    'dilate',1, ...
    'weightDecay',weightDecay, ...
